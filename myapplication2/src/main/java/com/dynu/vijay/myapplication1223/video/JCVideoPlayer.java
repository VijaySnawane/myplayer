package com.dynu.vijay.myapplication.video;
...
import com.dynu.vijay.myapplication.R;
...
//            jcVideoPlayer.setAnimation(ra);
    ...
    public void updateStartImage1(int state) {
    ...
    public void init(Context context) {
        ...
        if (mPlaying) {
            updateStartImage1(CURRENT_STATE_PAUSE);
        } else {
            updateStartImage1(CURRENT_STATE_PLAYING);
        }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.start) {
            ...
            if (TextUtils.isEmpty(url)) {
                Toast.makeText(getContext(), "no_url", Toast.LENGTH_SHORT).show();
                return;
            }
